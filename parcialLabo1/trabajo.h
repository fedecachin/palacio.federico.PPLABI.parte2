 ...
 *
 */
int altaTrabajo(eTrabajo trabajos[], int tamTr, eBicicleta bicicletas[], int tamB, eColor colores[], int tamC, eTipo tipos[], int tamT, eServicio servicios[], int tamS, int* idTrabajo, eCliente clientes[], int tamCl);
